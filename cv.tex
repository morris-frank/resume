...
I want my work to have a real positive impact on the world and I favor team-work with enthusiaistic colleagues.
My current academic interst lies in deep generative modeling and Bayesian methods, VAEs and Flows.
I am especially intrigued by work on and applications to music and sound as well as a understanding of human perception.
...
{\href{https://uva.nl}{Universiteit van Amsterdam}}
{
    ...
    \begin{itemize}%
        \item Theory and practical implementation of the concepts of machine and deep learning: CNNs, RNNs/LSTMs, VAEs/Flows, GANs, MCMC/sampling, Gaussian process/Baysian modeling, ICA,
...
{\href{https://uni-heidelberg.de/en}{University Heidelberg}}
{
    ...
    \begin{itemize}
        \item Specialization on image processing and pattern recognition: Deep Learning, 3D Computer vision, medical image analysis, fariness in AI
        \item Courses on Pratical CS, Algorithms, DBMS, Theoretical informatics, Numerical methods and software engineering
        \item Minor in the basic conepts of Physics
    \end{itemize}
