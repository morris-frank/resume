...
\begin{entrylist}
    ...
    {09/2019--\\12/2019}
    {Internship}
    {\href{https://www.spinozacentre.nl/}{Spinoza Center, Amsterdam}}
    {
    ...
    {
        Building statistical models to analyze engine part quality and live fleet monitoring. Building a production ready data visualization app.\\
