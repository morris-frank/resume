...
\begin{zitemize}
\item From 0 to revenue in 2 quarters.
...
\begin{zitemize}
\item Engineered B2B tech from 0 to 500k€ ARR.
...
\item Full-stack developed in Next.js with scalable backend, remote-sensing and on-site customer mapping guidance tooling.
\item[] \texttt{Next.js{\|}TypeScript{\|}Prisma{\|}Mapbox{\|}Nivo{\|}Vercel}
\end{zitemize}

\subsection{{Software Architect Advisor \hfill 11/2024 --- 01/2026}}
